   ...
   <idinfo>
      <citation>
	    ...
	    <origin>U.S. Department of Commerce, U.S. Census Bureau, Geography 
	       ...
	       <title>TIGER/Line Shapefile, rd13,  state, Missouri, 113th Congressional District State-based</title>
	       <edition>rd13</edition>
	       <geoform>vector digital data</geoform>
	       <onlink>http://www2.census.gov/geo/tiger/TIGERrd13/CD113/tl_rd13_29_cd113.zip</onlink>
	 </citeinfo>
      </citation>
	   <descript>
	       ...
	       <Subject_Entity>Missouri(29)</Subject_Entity>
	   </descript>
		<timeperd>
			<timeinfo>
				<rngdates>
		...
		<spdom>
			<bounding>
				<westbc>-95.774704</westbc>
				<eastbc>-89.098968</eastbc>
				<northbc>40.61364</northbc>
				<southbc>35.995683</southbc>
			</bounding>
		</spdom>
		<keywords>
			<theme>
...
For the TIGER/Line Shapefiles, the Point and Vector Object Count for the G-polygon SDTS Point and Vector Object Type reflects the number of records in the shapefile attribute table.  For multi-polygon features, only one attribute record exists for each multi-polygon rather than one attribute record per individual G-polygon component of the multi-polygon feature.  TIGER/Line Shapefile multi-polygons are an exception to the G-polygon object type classification.  Therefore, when multi-polygons exist in a shapefile, the object count will be less than the actual number of G-polygons.</logic>
	     ...
	     <digform>
				...
				<digtopt>
					<onlinopt>
						<computer>
						  <networka>
						<networkr>http://www2.census.gov/geo/tiger/TIGERrd13/CD113/tl_rd13_29_cd113.zip</networkr>
						  </networka>
						</computer>
					</onlinopt>
				</digtopt>
	...
	<metainfo>
		...
		<Metadata_File_Identifier>tl_rd13_29_cd113.shp.xml</Metadata_File_Identifier>
